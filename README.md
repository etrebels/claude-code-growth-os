...
| `docs/principles-from-the-field.md` | A third thinking aid: operating principles drawn from running the motion itself (ownership, alignment, daily focus, decisions, reading the return, dependencies, judgment, coverage & attention, conflict & resolution, institutional memory, tools & capability, change) — each with a worked go-to-market example, plus a map of where they land in the kit |
